...
const messages = {
  en: {
    ...
    "torrent.delete_files": "Delete torrent and files",
    "torrent.delete_confirm": "Delete “{name}” and its files ({size})?",
    "torrent.delete_yes": "Delete",
    "torrent.delete_no": "Cancel",
    ...
    "toast.deleted_files": "Torrent and files deleted.",
    "toast.delete_partial":
  ...
  fr: {
    ...
    "list.actions": "ACTIONS",
    "disk.downloads": "Téléchargements",
    "disk.completed": "Terminés",
    ...
    "torrent.delete_files": "Supprimer le torrent et ses fichiers",
    "torrent.delete_confirm":
      "Supprimer « {name} » et ses fichiers ({size}) ?",
    "torrent.delete_yes": "Supprimer",
    "torrent.delete_no": "Annuler",
    ...
    "toast.deleted_files": "Torrent et fichiers supprimés.",
    "toast.delete_partial":
      "Torrent retiré, mais certains fichiers n’ont pas pu être supprimés.",
